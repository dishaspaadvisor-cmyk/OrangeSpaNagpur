  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="text-4xl font-bold text-[#F97519]">Terms & Conditions</h1>
        ...
        <section className="mt-8">
          <h2 className="text-2xl font-semibold text-[#F97519]">1. Acceptance of Terms</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">2. Spa Services</h2>
          <p className="mt-2 text-gray-700 leading-7">
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">3. Appointment & Booking Policy</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">4. Cancellation Policy</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">5. Payments & Pricing</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">6. Health & Safety</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">7. Website Usage</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">8. Intellectual Property</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">9. Limitation of Liability</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">10. Changes to Terms</h2>
        ...
        <div className="mt-10 flex items-center gap-4">
          <Link href="/" className="text-[#F97519] font-semibold hover:underline">Return to Home</Link>
        </div>
      </div>
    </main>
  );
