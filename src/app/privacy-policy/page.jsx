  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="mx-auto max-w-4xl px-6 py-16">
        <h1 className="text-4xl font-bold text-[#F97519]">Privacy Policy</h1>
        ...
        <section className="mt-8">
          <h2 className="text-2xl font-semibold text-[#F97519]">1. Introduction</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">2. Information We Collect</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">3. How We Use Your Information</h2>
          <ul className="mt-2 list-disc list-inside text-gray-700 leading-7">
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">4. Data Security</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">5. Cookies & Analytics</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">6. Third-Party Services</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">7. Information Sharing</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">8. Your Rights</h2>
        ...
        <section className="mt-6">
          <h2 className="text-2xl font-semibold text-[#F97519]">9. Changes to This Policy</h2>
        ...
        <div className="mt-10 flex items-center gap-4">
          <Link href="/contact" className="text-[#F97519] font-semibold hover:underline">Contact Us</Link>
