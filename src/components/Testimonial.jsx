...
const testimonials = [
  ...
  },
  {
    ...
    location: "Nagpur",
    review:
      "Orange Spa exceeded my expectations. The rooms were clean, the staff was courteous, and the therapy helped me completely relax after a stressful week.",
  },
  {
    name: "Amit Patel",
    location: "Wardha",
  ...
  },
  {
    ...
    location: "Nagpur",
    review:
      "The atmosphere is calm and soothing. Every detail is thoughtfully managed, making it one of the finest wellness destinations in Nagpur.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto mt-5 max-w-3xl text-lg leading-8 text-slate-600">
            Discover why clients choose Orange Spa Nagpur for
