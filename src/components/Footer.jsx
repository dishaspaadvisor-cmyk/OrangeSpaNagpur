      ...
      <div className="border-t border-zinc-800">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-6 py-6 text-gray-400 md:flex-row">
          ...
          <div className="flex gap-6">
            <Link href="/privacy-policy" className="transition text-gray-400 hover:text-[#F97519]">
                Privacy Policy
              </Link>

              <Link href="/terms" className="transition text-gray-400 hover:text-[#F97519]">
                Terms & Conditions
              </Link>
          </div>
        </div>
